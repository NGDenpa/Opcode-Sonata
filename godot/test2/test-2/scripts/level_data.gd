...
static func all_levels() -> Array:
	return [
		...
		},
		{
			...
			"thank_you": "Thank you. Hearing both speakers together again brought back those quiet weekend mornings with my family.",
			"mask": "laba",
			"cols": 13,
			"rows": 11,
		...
		},
		{
			...
			"thank_you": "The static is gone. I can tune it again, and the room feels like those old evenings at home.",
			"mask": "radio",
			"cols": 14,
			"rows": 10,
		...
		},
		{
			...
			"thank_you": "The stereo works again. I am glad I asked before giving up on it.",
			"mask": "yinxiang",
			"cols": 10,
			"rows": 10,
...

		{
			...
			"thank_you": "The tape plays clearly now. For a moment, it felt like my friend was in the room again.",
			"mask": "cidai",
			"cols": 14,
			"rows": 10,
